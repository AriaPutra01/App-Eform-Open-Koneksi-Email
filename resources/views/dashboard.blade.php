    ...
    <div style="background-image: url({{ asset('build/image/bjbBG.jpg') }})" class="bg-top lg:bg-left-top">
        <div class="hero bg-blue-950 bg-opacity-70 md:bg-opacity-0 ">
            <nav x-data="{ isOpen: false }"
                class="fixed z-10 top-0 right-0 left-0 md:top-5 md:right-5 md:left-5 bg-white shadow-md md:rounded-md">
    ...
    <main>
        ...
        <div class="flex flex-wrap justify-center">
            <div class="w-full md:w-1/2 p-8">
                <a href="{{ route('pemohon.formKoneksi.create') }}"
                    style="background-image: url({{ asset('build/image/jabat.jpeg') }})"
                    class="relative group bg-cover block h-full rounded-md shadow-2xl transition hover:-translate-y-4 hover:bg-white duration-300 overflow-hidden">
                    <h5
                        class="group-hover:opacity-0 transition-all absolute bg-gray-50 p-2 w-full text-lg font-bold text-black">
                        Form Koneksi
                    </h5>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor"
                        class="group-hover:opacity-0 transition-all absolute right-4 top-0 size-16 text-white bg-yellow-500 rounded p-1 shadow-lg">
                        <path stroke-linecap="round" stroke-linejoin="round"
                            d="M18 18.72a9.094 9.094 0 0 0 3.741-.479 3 3 0 0 0-4.682-2.72m.94 3.198.001.031c0 .225-.012.447-.037.666A11.944 11.944 0 0 1 12 21c-2.17 0-4.207-.576-5.963-1.584A6.062 6.062 0 0 1 6 18.719m12 0a5.971 5.971 0 0 0-.941-3.197m0 0A5.995 5.995 0 0 0 12 12.75a5.995 5.995 0 0 0-5.058 2.772m0 0a3 3 0 0 0-4.681 2.72 8.986 8.986 0 0 0 3.74.477m.94-3.197a5.971 5.971 0 0 0-.94 3.197M15 6.75a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm6 3a2.25 2.25 0 1 1-4.5 0 2.25 2.25 0 0 1 4.5 0Zm-13.5 0a2.25 2.25 0 1 1-4.5 0 2.25 2.25 0 0 1 4.5 0Z" />
                    </svg>
                    <div class="w-full h-full p-4 opacity-0 hover:opacity-100 rounded-md transition-all"
                        style="background-image: linear-gradient(to right, rgb(0, 129, 255, .9), rgb(0, 100, 200, .9));">
            ...
            <div class="w-full md:w-1/2 p-8">
                <a href="{{ route('permohonan.formEmail.create') }}"
                    style="background-image: url({{ asset('build/image/email.jpeg') }})"
                    class="relative group bg-cover bg-center block h-full rounded-md shadow-2xl transition hover:-translate-y-4 hover:bg-white duration-300 overflow-hidden">
                    <h5
                        class="group-hover:opacity-0 transition-all absolute bg-gray-50 p-2 w-full text-lg font-bold text-black">
                        Form Email
                    </h5>
