                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-center space-x-4">
                                ...
                                <a href="{{ route('admin.tableKoneksi') }}"
                                    class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-800 hover:bg-opacity-40 hover:text-white">Table
                                    koneksi</a>
                                <a href="{{ route('adminEmail.tableEmail') }}"
                                    class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-800 hover:bg-opacity-40 hover:text-white">Table
                                    e-mail</a>
                            </div>
                        </div>
            ...
            <div x-show=isOpen class="md:hidden transi" id="mobile-menu">
                <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
                    ...
                    <a href="{{ route('dashboardAdmin') }}"
                        ...
                        aria-current="page">Dashboard</a>
                    <a href="{{ route('admin.tableKoneksi') }}"
                        class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-400 hover:text-white">Table
                        koneksi</a>
                    <a href="{{ route('adminEmail.tableEmail') }}"
                        class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-400 hover:text-white">Table
                        e-mail</a>
                ...
                <div class="flex flex-wrap justify-center mt-10">
                    <div class="w-full md:w-1/2 p-6">
                        <a href="{{ route('admin.tableKoneksi') }}"
                            ...
                            <h5 class="text-lg font-bold mb-2 text-white">Table Koneksi</h5>
                    ...
                    <div class="w-full md:w-1/2 p-6">
                        <a href="{{ route('adminEmail.tableEmail') }}"
                            class="block h-full bg-blue-950 bg-opacity-70 hover:bg-opacity-100 hover:-translate-y-3 hover:shadow-2xl transition-all rounded-md shadow-lg p-4">
                            <h5 class="text-lg font-bold mb-2 text-white">Table Email</h5>
