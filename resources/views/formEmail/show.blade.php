                ...
                <div class="card-body">
                        ...
                        <div class="col">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="nama_ibu" name="nama_ibu"
                                    class="form-control @error('nama_ibu') is-invalid @enderror" value="{{ $post->nama_ibu }}"
                        ...
                        <div class="col">
                            ...
                            <div class="form-group">
                                ...
                                <select id="jabatan" name="jabatan" class="form-control @error('jabatan') is-invalid @enderror">
                                    ...
                                    <option value="Manager" {{ $post->jabatan == 'Manager' ? 'selected' : '' }}>Manager</option>
                                    <option value="Staff" {{ $post->jabatan == 'Staff' ? 'selected' : '' }}>Staff</option>
                                    <option value="Intern" {{ $post->jabatan == 'Intern' ? 'selected' : '' }}>Intern</option>
                                </select>
                        ...
                        <div class="col">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="no_tlp" name="no_telp"
                                    class="form-control @error('no_tlp') is-invalid @enderror" value="{{ $post->no_telp }}"
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="pendaftaran" id="inlineRadio1" value="pengaktifan" {{ $post->pendaftaran == 'pengaktifan' ? 'checked' : '' }}>
                            <label class="form-check-label" for="inlineRadio1">Pengaktifan</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="pendaftaran" id="inlineRadio2" value="penghapusan" {{ $post->pendaftaran == 'penghapusan' ? 'checked' : '' }}>
                    ...
                    {{-- <div class="button-group">
                        ...
                        <form action="{{ route('word', $post->id) }}" method="POST" style="display:inline;">
                            @csrf
