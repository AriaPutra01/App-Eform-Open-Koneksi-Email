            ...
            <div x-show="isOpen" x-transition:enter="transition ease-out duration-100 transform"
                ...
                <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
                    ...
                    <a href="{{ route('pemohon.formKoneksi.create') }}"
                        ...
                        koneksi</a>
                    <a href="{{ route('permohonan.formEmail.create') }}"
                        class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-blue-900 hover:text-white">Form
                        e-mail</a>
                </div>
            </div>
        </nav>
                    ...
                    <x-card>
                        <div class="col-span-full">
                            ...
                            <textarea id="tujuan" name="tujuan" rows="3"
                                class="mt-3 block w-full border-1 py-1.5 bg-gray-100 border-gray-300 focus:border-sky-500 focus:ring-sky-500 rounded-md shadow-sm">{{ old('tujuan') }}</textarea>
                    ...
                    <x-card>
                        ...
                        <div class="my-10 space-y-10">
                            ...
                            <div class="mt-6 flex items-center justify-end gap-x-6">
                                <button type="reset"
                                    class="text-sm font-semibold leading-6 text-gray-900 hover:text-red-500 transition-colors">Reset</button>
                                <button
                                    class="inline-flex items-center px-4 py-2 bg-blue-700 border border-gray-300 rounded-md font-semibold text-xs text-white uppercase tracking-widest shadow-sm hover:bg-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-25 transition ease-in-out duration-150"
                                    type="submit" name="word">{{ __('Export Docx') }}</button>
